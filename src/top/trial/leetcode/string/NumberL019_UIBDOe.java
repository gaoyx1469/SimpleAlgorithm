 ...
 * 
 * 来源：力扣（LeetCode） 链接：https://leetcode-cn.com/problems/UlBDOe
...
public class NumberL019_UIBDOe {

	public void solution() {
		String leaves = "rrryyyrryyyrr";
		System.out.println(mininumOperationOne(leaves));
	}

	//动态规划
	private int mininumOperationOne(String leaves) {
