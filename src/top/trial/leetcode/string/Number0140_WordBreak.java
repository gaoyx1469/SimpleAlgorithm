 ...
 * @Version 1.0
 */
public class Number0140_WordBreak {
    @Test
    public void solution() {
        String s = "pineapplepenapple";
        List<String> wordDict = new ArrayList<>(Arrays.asList("apple", "pen", "applepen", "pine", "pineapple"));
        ArrayListUtil.getOneDimensionalSysoLikeArray(wordBreakOne(s, wordDict));
    }

    private List<String> wordBreakOne(String s, List<String> wordDict) {
